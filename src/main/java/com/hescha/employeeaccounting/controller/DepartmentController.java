...
import com.hescha.employeeaccounting.service.DepartmentService;
...
@RequestMapping(DepartmentController.CURRENT_ADDRESS)
public class DepartmentController {
    public static final String API_PATH = "department";
    ...
    @PostMapping
    public String save(@ModelAttribute Department entity, RedirectAttributes ra) {
        if (entity.getId() == null) {
            try {
                Department createdEntity = service.create(entity);
